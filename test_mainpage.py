...
class MainPage():
    ...
    def start_click_searching(self):
        ...
        self.start_location_suggestions_dropdown_list.place(x=97, y= 275)
    ...
    def arrive_click_searching(self):
        ...
        self.arrive_location_suggestions_dropdown_list.place(x=97, y= 375)
    ...
    def thrifty_searching(self, start_loc=None, stop_loc=None):
        ...
        self.result_frame.place(x=495, y=268)
    ...
    def CreatePage(self):
        ...
        self.search_button.place(x=390, y=325)
        ...
        self.thrifty_btn.place(x=170, y=430)
